...
class DeviceTreeView(QTreeWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.selectorControlLoop.addItem('释放')
        self.selectorControlLoop.addItem('')
        self.selectorControlLoop.setItemText(0, '\u529b\u77e9\u63a7\u5236')
        self.selectorControlLoop.setItemText(1, '\u901f\u5ea6\u63a7\u5236')
        self.selectorControlLoop.setItemText(2, '\u89d2\u5ea6\u63a7\u5236')
        self.selectorControlLoop.setItemText(3, '\u901f\u5ea6\u5f00\u73af\u63a7\u5236')
        self.selectorControlLoop.setItemText(4, '\u89d2\u5ea6\u5f00\u73af\u63a7\u5236')
        self.selectorControlLoop.setItemText(5, '\u4ece\u52a8\u529b\u77e9\u63a7\u5236')
        self.selectorControlLoop.setItemText(6, '\u91ca\u653e')
        ...
        self.setColumnWidth(0, max(self.columnWidth(0), 220))
    ...
    def setTorqueMode(self, value):
        self.selectorTorque.blockSignals(True)
        ...
        self.selectorTorque.blockSignals(False)
    ...
    def setEnabledDisabled(self, value):
        self.selectStatus.blockSignals(True)
        if value == 0:
            self.selectStatus.setCurrentIndex(0)
        elif value == 1:
            self.selectStatus.setCurrentIndex(1)
        self.selectStatus.blockSignals(False)
    ...
    def setModCenter(self,value):
        self.selectModCenter.blockSignals(True)
        self.selectModCenter.setCurrentIndex(int(value))
        self.selectModCenter.blockSignals(False)
    ...
    def setModType(self, value):
        self.selectModulation.blockSignals(True)
        ...
        self.selectModulation.blockSignals(False)
    ...
    def _resumeControl(self, control_type):
    ...
    def changeControlLoop(self):
        ...
        if index == 0:
            self._resumeControl(SimpleFOCDevice.TORQUE_CONTROL)
        elif index == 1:
            self._resumeControl(SimpleFOCDevice.VELOCITY_CONTROL)
        elif index == 2:
            self._resumeControl(SimpleFOCDevice.ANGLE_CONTROL)
        elif index == 3:
            self._resumeControl(SimpleFOCDevice.VELOCITY_OPENLOOP_CONTROL)
        elif index == 4:
            self._resumeControl(SimpleFOCDevice.ANGLE_OPENLOOP_CONTROL)
