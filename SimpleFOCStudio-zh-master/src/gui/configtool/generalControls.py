...
class GeneralControls(QtWidgets.QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        self.gcVerticalLayout = QtWidgets.QVBoxLayout(self)
        self.gcVerticalLayout.setObjectName('gcVerticalLayout')
        ...
        self.gcVerticalLayout.addWidget(self.enableDeviceButton)
        ...
        self.gcVerticalLayout.addWidget(self.sensorZeroButton)
        ...
        self.gcVerticalLayout.addWidget(self.setZeroTarget)
        self.reloadValues()
