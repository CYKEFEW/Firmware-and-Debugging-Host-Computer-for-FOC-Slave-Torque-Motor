...
class ConfigureConnection(QtWidgets.QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        self.portNameComboBox.selectPreferredPort(self.device.serialPortName)
    ...
    def connectAction(self):
        preferred_port = self.portNameComboBox.getPreferredSerialPortName(
            self.portNameComboBox.currentText())
        if preferred_port:
            self.portNameComboBox.setCurrentText(preferred_port)
